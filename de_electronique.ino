...
if (digitalRead(bouton)==HIGH){
  ...
  traitement_1_et2_a();
  traitement_3_et4_a(nbAlea); //passage à la la fonction du chiffre à afficher de la valeur du dé (de 1 à 6)
...
void traitement_3_et4_a(int chiffre_a_afficher){
    ...
    for(int i=0;i<3000/dureeCli;++i){
              ...
              if (SegInutile){   //seg ne fait pas parti du chiffre à afficher
                ...
                //code manquant: tester si tous les segs du chiffre sont allumés pour sortir de la boucle
                //imperceptible => la boucle dure 3 secondes
              }
